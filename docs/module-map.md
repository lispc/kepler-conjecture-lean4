...
| 4 Hypermap | `hypermap/` | `Kepler/Text/Hypermap.lean` | 🟡 至 convolution + Moebius contour 基础（hypermap.hl ~5400 行，Euler 主定理已证），Jordan 曲线定理链（LIPYTUI）与 iso 待做（图枚举侧见 Phase 2，hypermap_of_fan 桥接待做） |
