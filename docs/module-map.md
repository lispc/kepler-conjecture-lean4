...
| 4 Hypermap | `hypermap/` | `Kepler/Text/Hypermap.lean` | 🟡 至 walkup contour 保持/消去（hypermap.hl ~6080 行，Euler 主定理已证），lemmaLIPYTUI（Jordan 曲线定理）与 iso 待做（图枚举侧见 Phase 2，hypermap_of_fan 桥接待做） |
